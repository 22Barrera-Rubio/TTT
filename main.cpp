...
-Roll and check how many rolls are above a threshold ()
-Allow inputting data to a type of character list that you can change and access from menu (array type of thing ?) ()
